...
def remove_duplicates_2nd(the_list: list) -> list:
	"""This function takes a list and then returns another list containing the elements of the original list, but without duplicates. It accomplishes this by constructing a new list using a for loop.
	"""
	new_list = []
...
def main():
	...
	list_2 = remove_duplicates(list_1)
	list_3 = remove_duplicates_2nd(list_1)
	
	print('Initial list: ', list_1, '\n', 'Initial list without duplicates: ', list_3, sep='')
